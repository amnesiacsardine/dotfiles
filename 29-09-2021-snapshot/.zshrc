...
alias chown="chown -c"
alias mkdir="mkdir -v"
alias setgtk='gsettings set org.gnome.desktop.interface gtk-theme'
alias seticon='gsettings set org.gnome.desktop.interface icon-theme'
alias setcursor='gsettings set org.gnome.desktop.interface cursor-theme'
alias setfont='gsettings set org.gnome.desktop.interface font-name'
